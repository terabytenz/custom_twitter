		...
		callback: function(data) {
			...
			while(n < x) {
				...
				if (parseLinks) {
					...
					if (printUser) { //have edited to show twitter bird icon
						op += '<div class="user"><a href="https://twitter.com/lindsay_jopson" aria-label="Lindsay Jopson (screen name: lindsay_jopson)" data-scribe="element:user_link" target="_blank"><div class="iconf-twitter" aria-hidden="true"></div><span><span data-scribe="element:name">Lindsayt Jopson</span></span><span data-scribe="element:screen_name">@lindsay_jopson</span></a></div>';
					}
					op += '<div class="tweet__wrapper"><p class="tweet">' + strip(tweets[n].innerHTML) + '</p>';
					if (printTime) {
						if (permalinks) {
					...
					if (tweets[n].innerText) {
						...
						op += '<div class="tweet__wrapper"><p class="tweet">' +  tweets[n].innerText + '</p>';
						if (printTime) {
				...
				if (showInteractionLinks) {
					op += '<p class="interact"><a href="https://twitter.com/intent/' +
							'tweet?in_reply_to=' + tids[n] + '" class="twitter_reply_icon js-social-popup"' +
							(targetBlank ? ' target="_blank">' : '>') +
							'Reply</a><a href="https://twitter.com/intent/retweet?tweet_id=' +
							tids[n] + '" class="twitter_retweet_icon js-social-popup"' +
							(targetBlank ? ' target="_blank">' : '>') + 'Retweet</a>' +
							'<a href="https://twitter.com/intent/favorite?tweet_id=' +
							tids[n] + '" class="twitter_fav_icon js-social-popup"' +
